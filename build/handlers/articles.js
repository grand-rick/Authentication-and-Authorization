...
var store = new article_1.default();
...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var newArticle, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, store.create({ title: req.body.title, content: req.body.content })];
            case 1:
                newArticle = _a.sent();
                res.json(newArticle);
                return [3 /*break*/, 3];
...
var update = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, store.update({ id: req.params.id, title: req.body.title, content: req.body.content })];
            case 1:
                article = _a.sent();
                res.json(article);
                return [3 /*break*/, 3];
...
var articlesRoutes = function (app) {
